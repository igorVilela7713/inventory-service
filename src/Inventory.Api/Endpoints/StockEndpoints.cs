...
public static class StockEndpoints
{
    public static void MapStockEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapGet("/", async (InventoryService svc, int page = 0, int size = 20) =>
        {
        ...
        group.MapGet("/{productId}", async (string productId, InventoryService svc) =>
        {
        ...
        group.MapPost("/", async (CreateStockItemRequest request, IValidator<CreateStockItemRequest> validator, InventoryService svc) =>
        {
        ...
        group.MapPost("/{productId}/adjust", async (string productId, StockAdjustRequest request, InventoryService svc) =>
        {
